...
MySQL - 5.7.22-log : Database - clouddisk
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_clouddisk` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
INSERT  INTO `sys_user`(`id`,`username`,`password`,`email`,`role_code`,`role_name`,`gmt_create`,`gmt_update`,`nickname`,`user_create`) VALUES (1,'admin','a37e6cd2242e53585a469256633729b65b13d9853a34508d','123456@qq.com','admin','管理员','2019-03-21 14:30:57','2019-03-21 14:30:57','admin',1);
